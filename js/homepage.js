(function () {
  ...
  function renderRunningError() {
    ...
    runningValue.textContent = `-- / ${RUNNING_TARGET_KM} km`;
    runningStatus.textContent = "暂时无法同步 Running 数据，请稍后刷新重试。";
    runningProgress.style.width = "0%";
    runningGrid.innerHTML = "";

    const empty = document.createElement("p");
    empty.className = "homepage-running-empty";
    empty.textContent = "Running 模块已降级显示。";
    runningGrid.appendChild(empty);
  }
